package UI.abstract.resources
{
	...
	public class ResourceManager
	{
		...
		/** 资源缺省生命周期 **/
		public var resourceRecycleLife : int         = 5;

		/** 最小GC时间 **/
		public var minGCTimeInterval : int           = 5;
...
//			App.log.info( "开始自动回收资源。。。" , LogManager.LOG_NORMAL , "ResourceManager" , "recycleResources" );
		 ...
		 */
		public function load ( url : String , onComplete : Function , obj : Object = null ) : void
		{
			if ( !obj )
				obj = {};
			if ( onComplete != null )
		 ...
		 * onCompleteParam
		 */
		public function loadList ( urlList : Array , onComplete : Function , obj : Object = null ) : void
		{
			...
			if ( onComplete != null )
				obj.onComplete = onComplete;
			multiLoader = new MultiLoader( this , urlList , obj );
