package example
{
	...
	public class GUI1 extends Sprite
	{
		...
		private function createUi():void
		{
			...
			var mc:MovieClip=new MovieClip(ResourceUtil.getResourcePathByXML("ui/atlas.xml", ResourceUtil.MC, "flight_"), 24);
			mc.x=300;
			mc.y=0;
			box4.addChild(mc);
			...
			var animation:Animation=new Animation(AnCategory.NPC, "500000025", 0);
			animation.dir=4;
			animation.action=1;
			animation.x=200;
			animation.y=350;
